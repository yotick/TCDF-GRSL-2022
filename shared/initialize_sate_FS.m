...
if (strcmp(sate, 'ik'))
    ...
    if(coll_flag == 0)
        ...
        savepath_F = strcat(algo_name,'\fused/IKONOS\ik_4b_FS');   % fused image
        savepath_up =  strcat(algo_name,'\fused/IKONOS\ik_up_ms_FS');  % ms image
        savepath_rgb =  strcat(algo_name,'\fused/IKONOS\ik_rgb_FS');   % gt image
        savepath_up_rgb =  strcat(algo_name,'\fused/IKONOS\ik_up_rgb_FS');
    end
